	...
	return (
		<div className="content-section">
			...
			<ol>
				...
				<li>
					<b>Transparency:</b> Rules, format, schedule and any other tournament information must be clearly communicated to all participants. Any changes must be transparently announced.{" "}
				</li>
				<li>
					<b>Impartiality:</b> Tournament organizers and staff must remain impartial and avoid any conflicts of interest or favoring particular participants.{" "}
				</li>
			</ol>
			<p>Violation of any of these rules will result in your suspension as a tournament host</p>
			<p>- ilia21</p>
		</div>
	);
};

export default TourneyGuidelines;
